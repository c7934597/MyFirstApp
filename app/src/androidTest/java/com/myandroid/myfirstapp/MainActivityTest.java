...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public void maleAge25(){
        ...
        //檢查是否顯示正確的字串
        String asd = mMainActivity.getString(R.string.sug_not_hurry);
        String asdd =mTxtResult.getText().toString();

        assertEquals("建議:"+mMainActivity.getString(R.string.sug_not_hurry),mTxtResult.getText().toString());
    }
